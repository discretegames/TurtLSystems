...
[Intro][intro] | [Installation][install] | [Usage][usage] | [Instructions][inst] | [Links][links]
...
The Python imaging library [Pillow][pillowdoc] (PIL) is also required for png and gif output but it should be installed automatically if it
isn't already when you install TurtLSystems.
